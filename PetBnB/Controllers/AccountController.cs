...
namespace PetBnB.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // show view to user to check email and confirm email
        ...
        {
            // if already signed in, auto‑send the reset link
            if (User.Identity.IsAuthenticated)
            {
                ...
                // Show “check your inbox” no matter what
                return View("ForgotPasswordConfirmation");
            }

            // if not signed in, render the form so they can type in their email address
            return View();
        }
