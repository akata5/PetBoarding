...
namespace PetBnB
{
    ...
    public static class EmailServiceCredentials
    {
        ...
        public static void SetCredentials(string emailSMTPUrl, string portNumber, string emailSMTPPasswordHash, string emailFromAddress, string emailFromName, string emailAppName, string emailSMTPUserNameHash)
        {
        ...
        public static void PopulateEmailCredentialsFromAppConfig()
        {
            ...
            SetCredentials(emailSMTPURL, PortNumber, emailSMTPPasswordHash, emailFromAddress, emailFromName, emailAppName, emailSMTPUserNameHash);
        }
    }
